...
public static partial class HtmlHelperExtensions
{
  ...
  public static IPinterestHtmlHelper Pinterest(this HtmlHelper html) => html is not null ? pinterest ??= new PinterestHtmlHelper() : throw new ArgumentNullException(nameof(html));
}