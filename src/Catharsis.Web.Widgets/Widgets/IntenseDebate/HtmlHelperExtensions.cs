...
public static partial class HtmlHelperExtensions
{
  ...
  public static IIntenseDebateHtmlHelper IntenseDebate(this HtmlHelper html) => html is not null ? intensedebate ??= new IntenseDebateHtmlHelper() : throw new ArgumentNullException(nameof(html));
}