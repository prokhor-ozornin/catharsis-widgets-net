...
{
  private static ISoundCloudWidgetCreator soundcloud;
  ...
  public static ISoundCloudWidgetCreator SoundCloud(this IWebWidgetsCreator creator) => creator is not null ? soundcloud ??= new SoundCloudWidgetCreator() : throw new ArgumentNullException(nameof(creator));
}