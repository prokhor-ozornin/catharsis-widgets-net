...
{
  private static ISoundCloudWidgetsCreator SoundCloudProperty { get; set; }
  ...
  public static ISoundCloudWidgetsCreator SoundCloud(this IWebWidgetsCreator creator) => creator is not null ? SoundCloudProperty ??= new SoundCloudWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}