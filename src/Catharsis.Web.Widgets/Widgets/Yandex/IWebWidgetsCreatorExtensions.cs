...
{
  private static IYandexWidgetsCreator YandexProperty { get; set; }
  ...
  public static IYandexWidgetsCreator Yandex(this IWebWidgetsCreator creator) => creator is not null ? YandexProperty ??= new YandexWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}