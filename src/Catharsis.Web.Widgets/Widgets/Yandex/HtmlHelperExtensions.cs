...
public static partial class HtmlHelperExtensions
{
  ...
  public static IYandexHtmlHelper Yandex(this HtmlHelper html) => html is not null ? yandex ?? (yandex = new YandexHtmlHelper()) : throw new ArgumentNullException(nameof(html));
}