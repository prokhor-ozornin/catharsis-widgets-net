...
{
  private static IGoogleWidgetsCreator google;
  ...
  public static IGoogleWidgetsCreator Google(this IWebWidgetsCreator creator) => creator is not null ? google ??= new GoogleWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}