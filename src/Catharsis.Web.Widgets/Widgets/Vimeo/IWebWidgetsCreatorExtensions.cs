...
{
  private static IVimeoWidgetsCreator vimeo;
  ...
  public static IVimeoWidgetsCreator Vimeo(this IWebWidgetsCreator creator) => creator is not null ? vimeo ??= new VimeoWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}