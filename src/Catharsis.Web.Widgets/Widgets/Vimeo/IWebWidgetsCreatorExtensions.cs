...
{
  private static IVimeoWidgetsCreator VimeoProperty { get; set; }
  ...
  public static IVimeoWidgetsCreator Vimeo(this IWebWidgetsCreator creator) => creator is not null ? VimeoProperty ??= new VimeoWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}