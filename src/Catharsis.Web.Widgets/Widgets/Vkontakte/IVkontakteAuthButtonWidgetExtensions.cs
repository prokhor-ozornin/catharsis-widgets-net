...
public static class IVkontakteAuthButtonWidgetExtensions
{
  ...
  public static IVkontakteAuthButtonWidget Width(this IVkontakteAuthButtonWidget widget, short width) => widget?.Width(width.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
