...
{
  private static IVkontakteWidgetsCreator VontakteProperty { get; set; }
  ...
  public static IVkontakteWidgetsCreator Vkontakte(this IWebWidgetsCreator creator) => creator is not null ? VontakteProperty ??= new VkontakteWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}