...
{
  private static IVkontakteWidgetCreator vkontakte;
  ...
  public static IVkontakteWidgetCreator Vkontakte(this IWebWidgetsCreator creator) => creator is not null ? vkontakte ??= new VkontakteWidgetCreator() : throw new ArgumentNullException(nameof(creator));
}