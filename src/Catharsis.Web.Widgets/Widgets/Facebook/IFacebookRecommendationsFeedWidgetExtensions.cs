...
public static class IFacebookRecommendationsFeedWidgetExtensions
{
  ...
  extension(IFacebookRecommendationsFeedWidget widget)
  {
    /// <summary>
    ...
    public IFacebookRecommendationsFeedWidget Actions(params string[] actions) => widget?.Actions(actions) ?? throw new ArgumentNullException(nameof(widget));
    ...
    public IFacebookRecommendationsFeedWidget Width(short width) => widget?.Width(width.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
    ...
    public IFacebookRecommendationsFeedWidget Height(short height) => widget?.Height(height.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
    ...
    public IFacebookRecommendationsFeedWidget ColorScheme(FacebookColorScheme scheme) => widget?.ColorScheme(scheme.ToString().ToLowerInvariant()) ?? throw new ArgumentNullException(nameof(widget));
  }
}