...
public static class IFacebookPostWidgetExtensions
{
  ...
  public static IFacebookPostWidget Url(this IFacebookPostWidget widget, Uri url) => widget?.Url(url?.ToString()) ?? throw new ArgumentNullException(nameof(widget));
  ...
  public static IFacebookPostWidget Width(this IFacebookPostWidget widget, short width) => widget?.Width(width.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
}