...
{
  private static IRuTubeWidgetsCreator RuTubeProperty { get; set; }
  ...
  public static IRuTubeWidgetsCreator RuTube(this IWebWidgetsCreator creator) => creator is not null ? RuTubeProperty ??= new RuTubeWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}