...
public static class IMailRuFacesWidgetExtensions
{
  ...
  public static IMailRuFacesWidget Height(this IMailRuFacesWidget widget, short height) => widget?.Height(height.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
  ...
  public static IMailRuFacesWidget Width(this IMailRuFacesWidget widget, short width) => widget?.Width(width.ToInvariantString()) ?? throw new ArgumentNullException(nameof(widget));
}