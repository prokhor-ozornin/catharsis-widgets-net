...
{
  /// <summary>
  ///   <para>Renders required JavaScript tags for Cackle widgets.</para>
  /// </summary>
  ...
  public static IHtmlString Cackle(this IWidgetsScriptsRenderer renderer) => renderer is not null ? Scripts.Render("~/WebWidgets/Cackle") : throw new ArgumentNullException(nameof(renderer));
}