...
public static class ITwitterFollowButtonWidgetExtensions
{
  ...
  extension(ITwitterFollowButtonWidget widget)
  {
    /// <summary>
    ...
    public ITwitterFollowButtonWidget Language(CultureInfo culture)
    {
    ...
    public ITwitterFollowButtonWidget Size(TwitterFollowButtonSize size) => widget?.Size(size.ToString().ToLowerInvariant()) ?? throw new ArgumentNullException(nameof(widget));
    ...
    public ITwitterFollowButtonWidget Alignment(TwitterFollowButtonAlignment alignment) => widget?.Alignment(alignment.ToString().ToLowerInvariant()) ?? throw new ArgumentNullException(nameof(widget));
  }
}