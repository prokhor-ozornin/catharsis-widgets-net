...
{
  /// <summary>
  ///   <para>Renders required JavaScript tags for Twitter widgets.</para>
  /// </summary>
  ...
  public static IHtmlString Twitter(this IWidgetsScriptsRenderer renderer) => renderer is not null ? Scripts.Render("~/WebWidgets/Twitter") : throw new ArgumentNullException(nameof(renderer));
}