...
{
  private static IPayPalWidgetCreator paypal;
  ...
  public static IPayPalWidgetCreator PayPal(this IWebWidgetsCreator creator) => creator is not null ? paypal ??= new PayPalWidgetCreator() : throw new ArgumentNullException(nameof(creator));
}