...
public static partial class HtmlHelperExtensions
{
  ...
  public static IRobokassaHtmlHelper Robokassa(this HtmlHelper html) => html is not null ? robokassa ??= new RobokassaHtmlHelper() : throw new ArgumentNullException(nameof(html));
}