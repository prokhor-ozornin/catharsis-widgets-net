...
{
  private static IDisqusWidgetsCreator DisqusProperty { get; set; }
  ...
  public static IDisqusWidgetsCreator Disqus(this IWebWidgetsCreator creator) => creator is not null ? DisqusProperty ??= new DisqusWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}