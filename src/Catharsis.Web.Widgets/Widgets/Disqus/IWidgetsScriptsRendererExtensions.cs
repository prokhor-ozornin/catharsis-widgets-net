...
public static partial class IWidgetsScriptsRendererExtensions
{
  ...
  public static string Disqus(this IWidgetsScriptsRenderer renderer) => renderer is not null ? resources.disqus_js : throw new ArgumentNullException(nameof(renderer));
}