...
{
  private static IYouTubeWidgetsCreator YouTubeProperty { get; set; }
  ...
  public static IYouTubeWidgetsCreator YouTube(this IWebWidgetsCreator creator) => creator is not null ? YouTubeProperty ??= new YouTubeWidgetsCreator() : throw new ArgumentNullException(nameof(creator));
}