...
public static partial class HtmlHelperExtensions
{
  ...
  public static IYouTubeHtmlHelper YouTube(this HtmlHelper html) => html is not null ? youtube ??= new YouTubeHtmlHelper() : throw new ArgumentNullException(nameof(html));
}