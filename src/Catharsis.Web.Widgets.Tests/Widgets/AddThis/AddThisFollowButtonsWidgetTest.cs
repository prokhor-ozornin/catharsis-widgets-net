...
public sealed class AddThisFollowButtonsWidgetTest : Test
{
  ...
  /// </summary>
  public AddThisFollowButtonsWidgetTest() => Widget = Fixture.Create<IAddThisFollowButtonsWidget>();
  ...
  public void Clone_Method()
  {
    using (new AssertionScope())
    {
      Validate(new AddThisFollowButtonsWidget());
      Validate(Fixture.Create<IAddThisFollowButtonsWidget>());
    }

    return;

    static void Validate(IAddThisFollowButtonsWidget original)
    {
