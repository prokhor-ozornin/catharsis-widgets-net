...
public sealed class GooglePlusOneButtonWidgetTest : Test
{
  ...
  public void Url_Method()
  {
    ...
    static void Test(string url, IGooglePlusOneButtonWidget widget) => widget.Url(url).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("UrlValue").Should().Be(url);
  }
  ...
  public void Width_Method()
  {
    ...
    static void Test(string width, IGooglePlusOneButtonWidget widget) => widget.Width(width).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("WidthValue").Should().Be(width);
  }
  ...
  public void Size_Method()
  {
    ...
    static void Test(string size, IGooglePlusOneButtonWidget widget) => widget.Size(size).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("SizeValue").Should().Be(size);
  }
  ...
  public void Alignment_Method()
  {
    ...
    static void Test(string alignment, IGooglePlusOneButtonWidget widget) => widget.Alignment(alignment).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("AlignmentValue").Should().Be(alignment);
  }
  ...
  public void Annotation_Method()
  {
    using (new AssertionScope())
    {
      ...
      new[] { Fixture<string>.Create() }.ForEach(annotation => Test(annotation, Widget));
    }

    return;

    static void Test(string annotation, IGooglePlusOneButtonWidget widget) => widget.Annotation(annotation).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("AnnotationValue").Should().Be(annotation);
  }
  ...
  public void Callback_Method()
  {
    ...
    static void Test(string callback, IGooglePlusOneButtonWidget widget) => widget.Callback(callback).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("CallbackValue").Should().Be(callback);
  }
  ...
  public void Recommendations_Method()
  {
    ...
    static void Test(bool enabled, IGooglePlusOneButtonWidget widget) => widget.Recommendations(enabled).Should().BeSameAs(widget).And.Subject.GetPropertyValue<bool?>("RecommendationsValue").Should().Be(enabled);
  }
  ...
  public void Clone_Method()
  {
    ...
    static void Test(IGooglePlusOneButtonWidget original)
    {
