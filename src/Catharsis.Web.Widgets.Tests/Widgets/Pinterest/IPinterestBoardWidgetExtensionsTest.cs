...
/// </summary>
/// <seealso cref="IPinterestBoardWidgetExtensions"/>
public sealed class IPinterestBoardWidgetExtensionsTest : Test
{
  ...
  public void Height_Method()
  {
    ...
    static void Test(short height, IPinterestBoardWidget widget) => widget.Height(height).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("HeightValue").Should().Be(height.ToInvariantString());
  }
  ...
  public void Width_Method()
  {
    ...
    static void Test(short width, IPinterestBoardWidget widget) => widget.Width(width).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("WidthValue").Should().Be(width.ToInvariantString());
  }
  ...
  public void Header_Method()
  {
    ...
    static void Test(IPinterestBoardWidget widget)
    {
  ...
  public void Image_Method()
  {
    ...
    static void Test(short width, IPinterestBoardWidget widget) => widget.Image(width).Should().BeSameAs(widget).And.Subject.GetPropertyValue<string>("ImageValue").Should().Be(width.ToInvariantString());
  }
