...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static IVideoJSHtmlHelper VideoJS(this HtmlHelper html) => html is not null ? videoJS ?? (videoJS = new VideoJSHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}