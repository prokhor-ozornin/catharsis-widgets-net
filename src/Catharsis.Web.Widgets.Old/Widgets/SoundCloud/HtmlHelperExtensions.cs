...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static ISoundCloudHtmlHelper SoundCloud(this HtmlHelper html) => html is not null ? soundcloud ?? (soundcloud = new SoundCloudHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}