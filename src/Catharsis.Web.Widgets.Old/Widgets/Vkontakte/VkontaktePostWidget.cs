  ...
  public class VkontaktePostWidget : HtmlWidget, IVkontaktePostWidget
  {
    ...
    public override string ToHtmlString()
    {
      ...
      return
        ...
        new TagBuilder("script").Attribute("type", "text/javascript").InnerHtml(string.Format(@"(function() {{ window.VK && VK.Widgets && VK.Widgets.Post && VK.Widgets.Post(""{0}"", {1}, {2}, ""{3}"", {4}) || setTimeout(arguments.callee, 50); }}());", elementId, Owner(), Id(), Hash(), config.Json()));
    }
  }
}