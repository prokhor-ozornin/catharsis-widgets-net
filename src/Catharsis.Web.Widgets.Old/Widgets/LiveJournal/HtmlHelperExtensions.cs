...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static ILiveJournalHtmlHelper LiveJournal(this HtmlHelper html) => html is not null ? livejournal ?? (livejournal = new LiveJournalHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}