...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static IDisqusHtmlHelper Disqus(this HtmlHelper html) => html is not null ? disqus ?? (disqus = new DisqusHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}