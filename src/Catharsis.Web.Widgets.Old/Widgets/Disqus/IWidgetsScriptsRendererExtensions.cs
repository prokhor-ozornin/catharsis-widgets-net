...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class IWidgetsScriptsRendererExtensions
  {
    ...
    public static IHtmlString Disqus(this IWidgetsScriptsRenderer renderer) => renderer is not null ? Scripts.Render("~/WebWidgets/Disqus") : throw new ArgumentNullException(nameof(renderer));
  }
}