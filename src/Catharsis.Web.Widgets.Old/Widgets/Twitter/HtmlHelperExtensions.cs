...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static ITwitterHtmlHelper Twitter(this HtmlHelper html) => html is not null ? twitter ?? (twitter = new TwitterHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}