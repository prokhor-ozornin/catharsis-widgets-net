...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static ICackleHtmlHelper Cackle(this HtmlHelper html) => html is not null ? cackle ?? (cackle = new CackleHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}