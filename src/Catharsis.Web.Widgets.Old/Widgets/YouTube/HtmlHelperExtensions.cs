...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static IYouTubeHtmlHelper YouTube(this HtmlHelper html) => html is not null ? youtube ?? (youtube = new YouTubeHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}