...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static IMailRuHtmlHelper MailRu(this HtmlHelper html) => html is not null ? mailru ?? (mailru = new MailRuHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}