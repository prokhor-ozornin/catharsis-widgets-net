...
namespace Catharsis.Web.Widgets
{
  ...
  public static partial class HtmlHelperExtensions
  {
    ...
    public static IIntenseDebateHtmlHelper IntenseDebate(this HtmlHelper html) => html is not null ? intensedebate ?? (intensedebate = new IntenseDebateHtmlHelper()) : throw new ArgumentNullException(nameof(html));
  }
}