...
namespace Catharsis.Web.Widgets
{
  ...
  public static class IVkontakteHtmlHelperExtensions
  {
    ...
    /// <summary>
    ///   <para>Creates new VKontakte video hyperlink widget.</para>
    /// </summary>
    /// <param name="html">Helper object to call method on.</param>
    /// <param name="builder">Delegate that performs configuration of the widget.</param>
    /// <returns>HTML contents of configured and rendered widget.</returns>
    /// <exception cref="ArgumentNullException">If either <paramref name="html"/> or <paramref name="builder"/> is a <c>null</c> reference.</exception>
    /// <seealso cref="IVkontakteHtmlHelper.VideoLink()"/>
    public static string VideoLink(this IVkontakteHtmlHelper html, Action<IVkontakteVideoLinkWidget> builder)
    {
      Assertion.NotNull(html);
      Assertion.NotNull(builder);
