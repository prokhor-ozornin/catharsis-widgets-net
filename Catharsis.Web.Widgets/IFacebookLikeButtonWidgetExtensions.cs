...
namespace Catharsis.Web.Widgets
{
  ...
  public static class IFacebookLikeButtonWidgetExtensions
  {
    ...
    public static IFacebookLikeButtonWidget Layout(this IFacebookLikeButtonWidget widget, FacebookLikeButtonLayout layout)
    {
      ...
      switch (layout)
      {
        case FacebookLikeButtonLayout.BoxCount :
          layoutName = "box_count";
        break;

        case FacebookLikeButtonLayout.ButtonCount :
          layoutName = "button_count";
        break;

        case FacebookLikeButtonLayout.Standard :
          layoutName = "standard";
        break;
    ...
    /// <summary>
    ///   <para>Specifies the verb to display on the button.</para>
    /// </summary>
    /// <param name="widget">Widget to call method on.</param>
    ...
    /// <summary>
    ///   <para>Specifies color scheme used by the button.</para>
    /// </summary>
    /// <param name="widget">Widget to call method on.</param>
    ...
    public static IFacebookLikeButtonWidget ColorScheme(this IFacebookLikeButtonWidget widget, FacebookLikeButtonColorScheme scheme)
    {
      Assertion.NotNull(widget);

      return widget.ColorScheme(Enum.GetName(typeof(FacebookLikeButtonColorScheme), scheme).ToLowerInvariant());
    }
  }
}