...
namespace Catharsis.Web.Widgets
{
  ...
  public interface IYandexAnalyticsWidget : IHtmlWidget
  {
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget Accurate(bool enabled = true);
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget ClickMap(bool enabled = true);
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget NoIndex(bool enabled = true);
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget TrackHash(bool enabled = true);
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget TrackLinks(bool enabled = true);
    ...
    /// <returns>Reference to the current widget.</returns>
    IYandexAnalyticsWidget WebVisor(bool enabled = true);
  }
}