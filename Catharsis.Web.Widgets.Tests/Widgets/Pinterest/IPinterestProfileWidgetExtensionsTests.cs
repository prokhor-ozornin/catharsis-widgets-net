...
namespace Catharsis.Web.Widgets
{
  ...
  public sealed class IPinterestProfileWidgetExtensionsTests
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="IPinterestProfileWidgetExtensions.ImageWidth(IPinterestProfileWidget, short)"/> method.</para>
    /// </summary>
    [Fact]
    public void ImageWidth_Method()
    {
      Assert.Throws<ArgumentNullException>(() => IPinterestProfileWidgetExtensions.ImageWidth(null, 0));
